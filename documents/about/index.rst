...
Eshva.Fenix
================================================================================
пример распределённой системы с асинхронным межсервисным взаимодействием
------------------------------------------------------------------------

Как следует из описания — это пример распределённой системы, сервисы которой взаимодействуют между собой по средствам асинхронных сообщений. Выбранной предметной областью является :doc:`кредитование крупных корпоративных клиентов <domain/domain-description>`. Основной решаемой задачей — :doc:`автоматизация согласования лимита группы компаний <requirements/functional-requirements>`.
...
Выбор архитектурных решений продиктован архитектурными требованиями (их часто называют «нефункциональными»), предъявленных системе со стороны заказчиков. Более подробно требования я разбираю в статье :doc:`Архитектурные требования <requirements/architectural-requirements>`, а сами решения буду фиксировать в отдельных [статьях](TODO: ссылка на раздел «Архитектурные решения»).
